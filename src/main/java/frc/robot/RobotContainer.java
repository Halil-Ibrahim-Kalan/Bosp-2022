...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(PANEL, 7).whileHeld(new TriggerCmd(m_trigger, 1));
    new JoystickButton(PANEL, 5).whileHeld(new TriggerCmd(m_trigger, -1));
    
    new JoystickButton(PANEL, 12).whileHeld(new HubCmd(m_shooter, m_trigger, m_indexer, 0.8)); // UpperHub
    new JoystickButton(PANEL, 11).whileHeld(new HubCmd(m_shooter, m_trigger, m_indexer, 0.4)); // LowerHub
