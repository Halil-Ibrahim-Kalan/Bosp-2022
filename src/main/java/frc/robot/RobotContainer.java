...
import frc.robot.commands.Shooter.LowerHubCmd;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(PANEL, 12).whileHeld(new UpperHubCmd(m_shooter, 0.8));
    new JoystickButton(PANEL, 11).whileHeld(new LowerHubCmd(m_shooter, 0.4));
