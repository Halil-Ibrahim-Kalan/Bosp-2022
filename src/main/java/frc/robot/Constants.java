...
public final class Constants {
    ...
    public static final class IntakeConstants {
        ...
        // intake arm
        public static final int ARM_MOTOR_PWM = 11;
    }
    ...
    public static final class TriggerConstants {
        public static final int TRIGGER_MOTOR_PWM = 4;
    }
    ...
    public static final class ClimberConstants {
        public static final int FIXED_CLIMBER_MOTOR_ID = 3;
        public static final int ELEVATOR_MOTOR1_PWM = 5;
        public static final int ELEVATOR_MOTOR2_PWM = 6;
        public static final int ENCODER_CHANNEL_A = 0;
        public static final int ENCODER_CHANNEL_B = 1;
        public static final boolean ENCODER_REVERSE_DIRECTION = true;
    }
